                ...
                instructors?.map(instructor => {
                    return (
                        <SwiperSlide style={{textAlign: "left"}}>
                            <Link to={`/instructor/profile/${instructor.id}`} className="hover:bg-[#f4f2f2] duration-300 flex shadow-md px-3 py-5 pb-10 gap-x-4">
                                <div className="w-1/4">
                                    <div>
                                        <img src={instructor?.profilePicture} alt="" className="w-24 rounded-full"/>
                                    </div>
                                </div>
                                <div className="w-3/4 text-sm flex flex-col gap-y-1">
                                    ...
                                    <Rating
                                            ...
                                            readonly={true}
                                            />
                                    <p className="text-xs"><span className="font-bold">{instructor?.Courses.length}</span> courses</p>
