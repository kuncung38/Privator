...
const DetailCourse = () => {
  ...
  return (
    <div className="">
      <div className="bg-[#4D4861] helvetica-bold px-20 py-10 text-white pr-[30.5rem] flex flex-col gap-y-4">
        <p id="category" className="w-2/3 text-[#F2AF29]">
      ...
      <div className="flex px-20">
        <div className="py-20 w-4/6 flex flex-col gap-y-7">
          ...
          <div>
            ...
            <p className="text-sm text-justify pr-8">{course?.detail}</p>
          </div>
          <div>{/* <h1 className="text-2xl font-bold mb-2">Review</h1> */}</div>
        </div>
        <div className="w-3/6 -translate-y-64 bg-white shadow-2xl rounded-lg h-1/3 m-10">
          <div className="w-full rounded-">
            <img
              src={course?.imgUrl}
              alt=""
              className="object-cover w-full h-[23rem] rounded-lg"
            />
          </div>
          <div className="px-6 py-7">
            ...
            <div className="flex flex-col gap-y-3 mt-7">
              ...
              <div
                onClick={toggleModal}
                className="text-center border text-white border-black py-3 hover:bg-[#f7f9fa] hover:text-black bg-[#292b2f] rounded-2xl"
              >
